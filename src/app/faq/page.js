  ...
  return (
    <div>
      <div className="main-wrapper">
        ...
        <div className="meeta-faq-section section-padding">
          <div className="container">
            <div className="meeta-faq-wrapper">
                    ...
                    <div className="faq-col">
                        ...
                        >
                          <div className="accordion-body">
                            <p>
                              ...
                              ut labolore magna aliqua. Ut enim ad minim veniam.
                              Lorem ipsum dosectetur adipisicing elit, sed
                      ...
                      <div className="accordion-item">
                        <h2 className="accordion-header" id="headingTwo">
                          ...
                          >
                            Should I print a receipt to show?
                            <span className="faq-button">
                              <i className="fas fa-chevron-right"></i>
                            </span>
                          </button>
                        ...
                        >
                          <div className="accordion-body">
                            <p>
                              ...
                              organization. An LMS, or learning management
                              system, combines a wide range of features to
                              present.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="accordion-item">
                        ...
                        >
                          <div className="accordion-body">
                            <p>
                              Ac turpis egestas sed tempus urna et pharetra. In
                              tellus integer feugiat scelerisque varius. Urna
                              nec tincidunt praesent semper feugiat nibh sed.
                              Sollicitudin ac orci phasellus egestas tellus
                              rutrum tellus. Dictum varius duis at consectetur.
                              Blandit volutpat maecenas volutpat blandit aliquam
                              etiam. Scelerisque mauris pellentesque pulvinar
                              pellentesque habitant morbi. Vitae semper quis
