                      ...
                      <ul className="main-menu">
                        ...
                        <li className="active-menu">
                          ...
                          <ul className="sub-menu">
                            ...
                            <li>
                              <a href="/speaker-single">Speaker Single</a>
                            </li>
                            <li>
                        ...
                        <div className="col-lg-4 col-sm-6">
                          <div className="event-list-item">
                            ...
                            <div className="event-list-content">
                              ...
                              <h3 className="title">
                                <a href="event-single.html">
                                  Virtual Event with Protected Content and
                                  Hidden Livestream{" "}
                                </a>
                              </h3>
                              ...
                              <div className="event-desc">
                                <p>
                                  ...
                                  daunting at first. How do we maintain all
                                  these issues, or automatically trigger enim ad
