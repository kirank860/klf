  ...
  return (
    <div>
      <div className="main-wrapper">
                    ...
                    <ul className="main-menu">
                      ...
                      <li className="active-menu">
                        ...
                        <ul className="sub-menu">
                          ...
                          <li>
                            <a className="active" href="/event_schedule">
                              Event Schedule
                            </a>
                          </li>
                          <li>
        ...
        <div className="schedule-section section-padding">
          <div className="container">
            <div className="row">
              <div className="col-lg-9">
                <div className="schedule-tag">
                  <ul>
                    ...
                    <li>
                      <a href="#">Yoga & Arabic</a>
                    </li>
                    <li>
                      <a href="#">Hip Hop</a>
                    </li>
                    <li>
                      <a href="#">Indoor Cycling</a>
                    </li>
                    <li>
                      <a href="#">Workout</a>
                    </li>
                ...
                <div className="schedule-sidebar-wrap">
                  <div className="schedule-sidebar">
                    ...
                    <div className="schedule-post">
                      <ul>
                        <li>
                          <a className="post-link" href="event-single.html">
